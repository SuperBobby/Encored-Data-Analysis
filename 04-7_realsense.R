...
#   ylim_RS_freq <- 300
  ...
  RS_duration      = add.window.line(RS_duration, plot_dt, plot_name, "sum_of_duration", windowingWeek, rownum_expDate)
  RS_freq          = add.window.line(RS_freq, plot_dt, plot_name, "freq", windowingWeek, rownum_expDate)
