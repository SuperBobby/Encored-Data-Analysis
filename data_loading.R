...
marg_defalut_table_hours <- loadSNUData(marg_defalut_table_hours, "marg", update_start, update_end, verbose = T)
 hcc_defalut_table_hours <- loadSNUData( hcc_defalut_table_hours, "hcc",  update_start, update_end, verbose = T)
  ux_defalut_table_hours <- loadSNUData(  ux_defalut_table_hours, "ux",   update_start, update_end, verbose = T)
